...
function Sidebar() {
  ...
  return (
    <div
      className={`gap-10 py-6 px-4 absolute top-0 left-0 bottom-0 flex flex-col justify-start items-start bg-[rgb(240,243,248)] z-100 transition-all duration-150 ${extended ? 'w-48' : 'w-19'
        }`}
    >
      ...
      <div className='flex flex-row items-center justify-center gap-1.5 duration-150'>
        <button className={`${extended ? 'w-max h-10 px-3 py-1.5' : 'w-10 h-10'} bg-[rgb(229,234,241)] rounded-full flex justify-center items-center duration-150 cursor-pointer`}>
      ...
      <div className={`flex flex-col absolute bottom-12 text-xl text-gray-500 justify-start items-start duration-150 transition-all`}>
        <div className='flex justify-start items-start gap-x-1.5 w-full'>
          <button className={`${extended ? 'w-max h-10 px-3 py-1.5' : 'w-10 h-10'} hover:bg-[rgb(229,234,241)] rounded-full flex justify-center items-center duration-150 cursor-pointer`}>
